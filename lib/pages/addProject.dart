                            ...
                            children: [
                              ...
                              Padding(
                                  ...
                                  child: CustomDropdownButton(
                                      value: _valueI,
                                      hint: Text(AppLocalizations().lbTas),
                                      items: [
                                        DropdownMenuItem(
                                          child: Row(
                                            children: [
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: langSave == 'en'
                                          ...
                                          : '5 أيام',
                                      hintStyle: TextStyle(
                                        fontFamily: 'Cairo-Regular',                                        color: HexColor.fromHex("#787878"),
                                        fontSize: 16,
                                      ),
                                      //can also add icon to the end of the textfiled
                                      //  suffixIcon: Icon(Icons.remove_red_eye),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              AppLocalizations().lbCreatePro,
                              textAlign: TextAlign.center,
                              style:
                                  TextStyle(fontFamily: 'Cairo-Bold',color: Colors.white, fontSize: 18),
                            ),
                          ),
