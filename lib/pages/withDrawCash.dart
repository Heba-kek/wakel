...
import 'package:wakel/pages/addBankAccount.dart';
import 'package:wakel/pages/packageSuccess.dart';

class withDrawCash extends StatefulWidget {
  @override
  _withDrawCash createState() => new _withDrawCash();
}

class _withDrawCash extends State<withDrawCash> {
                          ...
                          Padding(
                            ...
                            child: Padding(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 20,fontFamily: 'Cairo-SemiBold',
                                      color: HexColor.fromHex("#4DBDEF")),
                                )),
                          ),
                          Padding(
