...
class projectAwardCon extends StatefulWidget {
  final String lang;
  projectAwardCon(this.lang);
  @override
  _projectAwardCon createState() => new _projectAwardCon();
}

class _projectAwardCon extends State<projectAwardCon> {
  double rating = 3.5;
...
leadingWidth: 100,
          ...
          leading:  RaisedButton(
            ...
            color: Colors.white,
            child: Padding(
                padding:widget.lang=='ar'? EdgeInsets.fromLTRB(40, 45, 0, 25):
