...
class withDrawSuccess extends StatefulWidget {
  @override
  _withDrawSuccess createState() => new _withDrawSuccess();
}

class _withDrawSuccess extends State<withDrawSuccess> {
  double rating = 3.5;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          AppLocalizations().lbWithSuccess,
                      ...
                      Padding(
                        ...
                        child: Text(
                          AppLocalizations().lbWithSuccessMsg,
                          textAlign: TextAlign.center,
